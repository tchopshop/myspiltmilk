...
function spiltmilk_css_alter(&$css) {
...
function spiltmilk_form_alter(&$form, &$form_state, $form_id) {
	switch($form_id) {
  ...
  if ($form_id == 'search_block_form') {
    ...
    $form['search_block_form']['#default_value'] = t('Search for an article'); // Set a default value for the textfield
